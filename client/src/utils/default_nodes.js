...
export const default_nodes = {
    0   : [{id: uuid.v4(), props: {text:"Prodsell", className: ""}}, {id: uuid.v4(), props: {text:"Hello!", className: ""}}],
    1   : [
        getDivObject("", [
    ...
    3   : [
        ...
        {id: uuid.v4(), props: {text: "Register!", className: ""}},
        {id: uuid.v4(), props: {text: "Log in", className: ""}}
    ],
    4   : [
    ...
    11  : [
        getTextObject("2022 Company, Inc", "mb-3 mb-md-0 text-muted", SPAN_TAG),
    ],
    14  : [
        getDivObject("d-md-flex flex-md-equal w-100 my-md-3 ps-md-3", [
            getDivObject("bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden flex-md-equal-child", [
